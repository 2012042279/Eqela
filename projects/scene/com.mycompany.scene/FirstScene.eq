...
public class FirstScene : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		...
		color1 = add_sprite_for_color(Color.instance("red"), get_scene_width(), get_scene_height());
		color1.move(0, 0);

		
		rsc.prepare_image("Sonic", "Sonic", get_scene_width()*0.1, get_scene_height()*0.1);
		icon = add_sprite_for_image(SEImage.for_resource("Sonic"));
		icon.move(get_scene_width()*0.9, get_scene_height()*0.6);
		
		color2 = add_sprite_for_color(Color.instance("blue"), get_scene_width()*0.1, get_scene_height()*0.1);
		color2.move(get_scene_width()*0.9, get_scene_height()*0.7);
		
		color3 = add_sprite_for_color(Color.instance("white"), get_scene_width()*0.1, get_scene_height()*0.1);
		color3.move(get_scene_width()*0.9, get_scene_height()*0.8);
		
		color4 = add_sprite_for_color(Color.instance("green"), get_scene_width()*0.1, get_scene_height()*0.1);
